    ...
    async onShow() {
        ...
        if (globalData.selectedResource && Object.keys(globalData.selectedResource).length) {
            ...
            if (confirm) {
                console.log('跳转');
                wepy.navigateTo({
                    url: `/pages/cropper?url=${`https://pic1.58cdn.com.cn${globalData.selectedResource[0].resourceUrl}`}&ratio=4,3&onlineImage=true`,
                });
            ...
            wx.showActionSheet({
                ...
                success (tap) {
                    if (tap.tapIndex === 0) {
                        ...
                        wepy.navigateTo({
                            url: `/pages/resourceManage?limit=1&type=${type}&ratio=1,1`,
                        });
                    }
                },
            });
